...
def limit_gpu_memory(target_gb=20, device=0):
...
def main():
    ...
    parser.add_argument("--sample-seq", action="store_true", default=False,
                        help="sample midi seq to reduce vram")
    parser.add_argument("--gen-example-interval", type=int, default=1,
                        help="generate example interval. set 0 to disable")
    ...
    parser.add_argument("--accelerator", type=str, default="gpu",
                        choices=["cpu", "gpu", "tpu", "ipu", "hpu", "auto"], help="accelerator")
    parser.add_argument("--precision", type=str, default="bf16-true",
                        choices=["16-true", "16-mixed", "bf16-true", "bf16-mixed",
    ...
    parser.add_argument("--disable-benchmark", action="store_true", default=False,
                        help="disable cudnn benchmark")
    parser.add_argument("--log-step", type=int, default=1, help="log training loss every n steps")
    parser.add_argument("--val-step", type=int, default=1600,
                        help="valid and save every n steps, set 0 to valid and save every epoch")
